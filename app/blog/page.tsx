...
export default function BlogPage() {
  ...
  const blogStructuredData = {
    ...
    '@graph': [
      {
        '@type': 'CollectionPage',
        '@id': 'https://mukeshjungkhadka.com.np/blog#webpage',
        url: 'https://mukeshjungkhadka.com.np/blog',
        name: 'Digital Insights, Project Notes & Software Thinking',
        isPartOf: { '@id': 'https://mukeshjungkhadka.com.np/#website' },
      ...
      },
      {
        ...
        itemListElement: posts.map((post, index) => ({
          '@type': 'ListItem',
          position: index + 1,
          url: `https://mukeshjungkhadka.com.np/blog#${post.id}`,
          item: {
            '@type': 'BlogPosting',
            headline: post.title,
            ...
            author: { '@type': 'Person', name: 'Mukesh Khadka', url: 'https://mukeshjungkhadka.com.np' },
            image: post.cover,
            articleSection: post.category,
            mainEntityOfPage: 'https://mukeshjungkhadka.com.np/blog',
          },
        })),
      },
    ],

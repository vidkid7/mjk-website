...
export default function BlogPage() {
  ...
  const blogStructuredData = {
    ...
    '@graph': [
      {
        '@type': 'CollectionPage',
        '@id': 'https://mjk-website-vidkids-projects-93622fab.vercel.app/blog#webpage',
        url: 'https://mjk-website-vidkids-projects-93622fab.vercel.app/blog',
        name: 'Digital Insights, Project Notes & Software Thinking',
        isPartOf: { '@id': 'https://mjk-website-vidkids-projects-93622fab.vercel.app/#website' },
      ...
      },
      {
        ...
        itemListElement: posts.map((post, index) => ({
          '@type': 'ListItem',
          position: index + 1,
          url: `https://mjk-website-vidkids-projects-93622fab.vercel.app/blog#${post.id}`,
          item: {
            '@type': 'BlogPosting',
            headline: post.title,
            ...
            author: { '@type': 'Person', name: 'Mukesh Khadka', url: 'https://mjk-website-vidkids-projects-93622fab.vercel.app' },
            image: post.cover,
            articleSection: post.category,
            mainEntityOfPage: 'https://mjk-website-vidkids-projects-93622fab.vercel.app/blog',
          },
        })),
      },
    ],

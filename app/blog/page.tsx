      ...
      <div className="relative z-10">
        ...
        <section className="px-5 py-20 sm:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="glass-panel mx-auto mb-14 max-w-3xl rounded-[2rem] p-7 text-center sm:p-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {posts.map((post, index) => {
                ...
                return (
                  <motion.article id={post.id} key={post.id} initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: index * 0.06 }} className="glass-panel overflow-hidden rounded-[2rem] transition hover:-translate-y-1 hover:border-gold/70 hover:shadow-2xl hover:shadow-[#071a35]/15">

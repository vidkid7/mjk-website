        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@mukeshjungkhadka.com.np"
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-crimson/50 focus:border-crimson transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-crimson/50 focus:border-crimson transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-crimson text-white font-semibold rounded-xl hover:bg-crimson-dark transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
          ...
          <p className="text-center text-gray-400 text-xs mt-6">
            Protected Admin Area • Mukesh Jung Khadka Campaign
          </p>
        </div>
      </div>
    </div>

...
test('theme music stops after seventeen seconds and interface sounds do not add a second visible control', async () => {
  ...
  assert.match(player, /MUSIC_CLIP_DURATION_SECONDS\s*=\s*17/)

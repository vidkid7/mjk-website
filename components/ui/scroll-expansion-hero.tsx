...
const ScrollExpandMedia = ({
  ...
  return (
    ...
    >
      <section className="relative flex flex-col items-center justify-start min-h-[100dvh] bg-gradient-to-b from-[#0a0e1a] via-[#0f1729] to-[#0a0e1a]">
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          >
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-b from-[#0a0e1a]/70 via-[#0a0e1a]/40 to-[#0a0e1a]/80" />
              ...
              >
                {mediaType === 'video' ? (
                  mediaSrc.includes('youtube.com') ? (
                    ...
                    <div className="relative w-full h-full pointer-events-none bg-[#0a0e1a] rounded-2xl overflow-hidden">
                      <video
                        src={mediaSrc}
                        poster={posterSrc}
                        autoPlay
                  ...
                  <div className={`relative w-full h-full rounded-2xl overflow-hidden ${mediaBgClass || ''}`}>
                    <Image
                      src={mediaSrc}
                    ...
                    <div className="absolute inset-0 rounded-2xl ring-1 ring-crimson/20 shadow-[0_0_60px_rgba(220,38,38,0.15)]" />
                  </div>
                )}
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white/60 font-medium text-center"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>

  ...
  return (
    <section id="contact" className="relative bg-[#fbfaf7] py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <SectionHeading
          pill="Contact"
          heading="Let’s discuss your digital project"
          subheading="Have a website, software system, dashboard, automation idea, or portfolio project in mind? Send a message and we can discuss the best next step."
          accent="emerald"
        />
        ...
        <div className="mb-10 grid gap-5 lg:grid-cols-3">
          {[
            ...
            <motion.div
              ...
              className="rounded-lg border border-slate-200 bg-white p-6 text-center transition-all duration-300 hover:border-slate-300 hover:shadow-md"
            >
              <div className={`mx-auto mb-3 flex h-12 w-12 items-center justify-center border ${info.bg}`}>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <input
                ...
                className="w-full rounded-lg border border-slate-200 bg-white px-5 py-3.5 text-sm text-slate-900 placeholder:text-slate-400 transition-all duration-300 focus:border-emerald-600 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
                required
              />
              <input
                type="email"
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-slate-200 bg-white px-5 py-3.5 text-sm text-slate-900 placeholder:text-slate-400 transition-all duration-300 focus:border-emerald-600 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
              required
            />
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 bg-slate-950 py-4 text-xs font-bold uppercase tracking-[0.12em] text-white transition-all duration-300 hover:bg-emerald-700 hover:shadow-xl disabled:opacity-60"
            >
          ...
          <motion.div
            ...
            className="space-y-5"
          >
            <div className="h-[220px] overflow-hidden rounded-lg border border-slate-200 bg-white lg:h-[260px]">
              <iframe
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-6">
              <h4 className="mb-4 text-center text-sm font-semibold text-slate-900">Connect Online</h4>
              <div className="flex justify-center gap-3">
                {socialLinks.map((social) => (
                  <a
                    key={social.label}
                    href={social.url}
                    className={`flex h-11 w-11 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 ${social.color}`}
